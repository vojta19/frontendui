...
export const LinkURI = `${URIRoot}/user/view/`;
 ...
 */
export const Link = ({ item, children }) => <TemplateUI.Link LinkURI={LinkURI} item={item}>{children || item?.fullname || "Chybí data"}</TemplateUI.Link>;
