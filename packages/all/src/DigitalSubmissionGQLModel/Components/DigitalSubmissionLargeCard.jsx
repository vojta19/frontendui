 ...
 */
export const DigitalSubmissionLargeCard = ({digitalsubmission, children}) => {
    return (
        <DigitalSubmissionCardCapsule digitalsubmission={digitalsubmission} >
            <Row>
                <LeftColumn>
                    <DigitalSubmissionMediumCard digitalsubmission={digitalsubmission}/>
                </LeftColumn>
                <MiddleColumn>
                    {children}
                </MiddleColumn>
