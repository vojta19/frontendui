...
import { DigitalSubmissionSections } from "../Vectors/DigitalSubmissionSectionSectionsAttribute"
import { DigitalSubmissionFieldsAttribute } from "../../DigitalSubmissionGQLModel/Vectors/DigitalSubmissionFieldsAttribute"
 ...
 */
export const DigitalSubmissionSectionLargeContent = ({digitalsubmissionsection, children}) => {
    const {fields, sections} = digitalsubmissionsection
    return (
        <>
            {fields && <DigitalSubmissionSectionFields fields={fields} /> }
            {sections && <DigitalSubmissionSections sections={sections}/>}
            {/* <Row>
                <Col>fields</Col>
                <Col><pre>{JSON.stringify(fields, null, 2)}</pre></Col>
            </Row>
            <Row>
                <Col>sections</Col>
                <Col><pre>{JSON.stringify(sections, null, 2)}</pre></Col>
            </Row> */}
            {/* <Row>
                <Col>JSON</Col>
